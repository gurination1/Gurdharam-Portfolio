...
export function GlowingShadow({
  ...
  return (
    <>
      <style>{`
        ...
        .glow-content:before {
          ...
          background: hsl(0deg 0% 16%) radial-gradient(
            ...
            hsl(calc(var(--hue) * var(--hue-speed) * 1deg) 94% 88%) calc(0% * var(--bg-size)),
            hsl(calc(var(--hue) * var(--hue-speed) * 1deg) 84% 72%) calc(20% * var(--bg-size)),
            hsl(calc(var(--hue) * var(--hue-speed) * 1deg) 80% 55%) calc(40% * var(--bg-size)),
            transparent 100%
          );
        ...
        .glow {
          ...
          display: block;
          position: absolute;
          width: calc(min(560px, 100vw) / 5);
          height: calc(min(560px, 100vw) / 5);
        ...
        .glow:after {
          ...
          left: -15%;
          top: -15%;
          background: hsl(calc(var(--hue) * var(--hue-speed) * 1deg) 92% 62%);
          position: relative;
          border-radius: calc(var(--glow-radius) * 10vw);
          animation: hue-animation var(--animation-speed) linear infinite;
      ...
      <div className={`glow-container ${className}`} aria-hidden="false">
