...
const glowStyleId = "glow-card-styles"
...
const GlowCard: React.FC<GlowCardProps> = ({
  ...
  return (
    <div
      ...
      data-glow
      style={style}
      className={`${customSize ? "" : sizeMap[size]} ${!customSize ? "aspect-[3/4]" : ""} relative grid grid-rows-[1fr_auto] gap-4 rounded-2xl p-4 shadow-[0_1rem_2rem_-1rem_black] backdrop-blur-[5px] ${className}`}
    >
