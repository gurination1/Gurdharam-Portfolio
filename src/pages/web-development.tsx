...
export default function WebDevelopment() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Web Developer Chandigarh & Punjab | Gurdharam";
  }, []);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="border border-white/10 p-8 rounded-3xl bg-black/40 mb-16">
          ...
          <p className="text-secondary leading-relaxed mb-4">
            I deliver custom website development for businesses across Chandigarh, Punjab, and internationally. Every project complies with the digital frameworks of the <a href="https://www.meity.gov.in" target="_blank" rel="noopener noreferrer" className="text-accent-cold underline">Ministry of Electronics and Information Technology (MeitY)</a> and maps to the local business standards advocated by the <a href="https://www.cii.in" target="_blank" rel="noopener noreferrer" className="text-accent-cold underline">CII Northern Region</a>:
          </p>
