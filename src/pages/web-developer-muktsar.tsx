        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-card border border-white/5 p-8 rounded-3xl">
              ...
              <p className="text-secondary text-sm leading-relaxed">Custom chatbots utilizing large language models and RAG data. Designed for dental clinics, gyms, travel agencies, and hospitals to capture leads and book clients 24/7 using the official <a href="https://developers.facebook.com/documentation/business-messaging/whatsapp/about-the-platform" target="_blank" rel="noopener noreferrer" className="text-accent-cold underline">Meta Cloud API</a>.</p>
            </div>
            <div className="bg-card border border-white/5 p-8 rounded-3xl">
          ...
          <div className="flex items-start gap-4 bg-card border border-white/5 p-8 rounded-3xl">
            ...
            <div>
              ...
              <p className="text-secondary text-sm leading-relaxed mb-6">
                I provide local in-person software development consultation and website building services across **Muktsar Sahib, Bathinda, Faridkot, Ferozepur, Ludhiana, Jalandhar, Amritsar, and Chandigarh**. Combining native Punjabi and Hindi support with global development standards, my processes align with skill frameworks from <a href="https://www.nsdcindia.org/" target="_blank" rel="noopener noreferrer" className="text-accent-gold underline">NSDC India</a>, digital initiatives of <a href="https://www.india.gov.in/" target="_blank" rel="noopener noreferrer" className="text-accent-gold underline">India.gov.in National Portal</a>, and local commercial benchmarks set by the <a href="https://www.cii.in" target="_blank" rel="noopener noreferrer" className="text-accent-gold underline">CII Northern Region</a>. I build tailored systems for local agriculture cooperatives, hospitals, clinics, hotels, and travel agencies.
              </p>
            </div>
          </div>
        </section>
