...
// Optimized SVG Filter Component for compatibility
...
// High-Performance GPU-Accelerated Liquid Glass Effect
export const GlassEffect: React.FC<GlassEffectProps> = ({
  ...
  const glassStyle: React.CSSProperties = {
    boxShadow: "0 8px 24px rgba(0, 0, 0, 0.45), inset 0 1px 0 rgba(255, 255, 255, 0.2)",
  ...
  const content = (
    ...
    >
      ...
      />
      {/* 3. Liquid Specular Meniscus Bevel Highlight */}
      <div
        className="absolute inset-0 z-20 rounded-inherit overflow-hidden pointer-events-none"
        style={{
          boxShadow:
            "inset 1.5px 1.5px 0.5px rgba(255, 255, 255, 0.65), inset -1px -1px 0.5px rgba(255, 255, 255, 0.15)",
