        ...
        <section className="mb-16 space-y-6">
          ...
          <div className="space-y-6 bg-card border border-white/5 p-8 rounded-3xl">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Direct <a href="https://developers.facebook.com/documentation/business-messaging/whatsapp/about-the-platform" target="_blank" rel="noopener noreferrer" className="text-accent-gold underline hover:text-white transition-colors">Meta Cloud API</a> — Zero SaaS Reseller Fees</h3>
                <p className="text-secondary text-sm leading-relaxed">
